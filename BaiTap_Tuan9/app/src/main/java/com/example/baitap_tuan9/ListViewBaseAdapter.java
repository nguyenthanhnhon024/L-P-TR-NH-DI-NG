...
public abstract class ListViewBaseAdapter extends BaseAdapter {
    public ArrayList<com.example.baitap_tuan9.ListViewBean> arrayListListener;
    private List<com.example.baitap_tuan9.ListViewBean> mListenerList;
    Context mContext;

    public ListViewBaseAdapter(List<com.example.baitap_tuan9.ListViewBean> mListenerList, Context context){
        mContext = context;
        this.mListenerList = mListenerList;
        this.arrayListListener = new ArrayList<com.example.baitap_tuan9.ListViewBean>();
