...
public class Trasua_Data {
    ...
    public Trasua_Data(String itemName, String itemDescription, String itemPrice, String itemDanhGia, String itemKm, String itemGiamGia, int itemImage) {
