...
public class OrderCFragment extends Fragment {
    ...
    String mName309[] = {"Ice Americano", "Ice Cappucino", "Ice Espresso", "Ice Mocha", "Bạc Xĩu", "White Coffee"};
    String mPrice309[] = {"49.000đ", "39.000đ", "39.000đ", "30.000", "40.000đ", "30.000đ"};
    int images309[] = {R.drawable.american, R.drawable.capu, R.drawable.espresso, R.drawable.mocha, R.drawable.bacxiu, R.drawable.white};
    ...
    public static OrderCFragment newInstance(String param1, String param2) {
        OrderCFragment fragment309 = new OrderCFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root309 = inflater.inflate(R.layout.fragment_order_c, container, false);
        gridView309 = root309.findViewById(R.id.gv_passio);
        OrderCFragment.MyAdapter adapter309 = new OrderCFragment.MyAdapter(getActivity(), mName309, mPrice309, images309);
