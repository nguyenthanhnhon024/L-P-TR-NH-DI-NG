 ...
 * Use the {@link SilverFragment#newInstance} factory method to
...
public class SilverFragment extends Fragment {
    ...
    public static SilverFragment newInstance(String param1, String param2) {
        SilverFragment fragment309 = new SilverFragment();
